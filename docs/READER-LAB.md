...
- **Link-Unterstreichung:** `.reader a` setzt Farbe und Stärke der Dekoration, aber keine `text-decoration-line`; Chromium meldet deshalb für alle Artikel mit Links, dass nicht sämtliche Links unterstrichen sind. Stufe 5 fügt laut Auftrag keine neue Produktfunktion hinzu und dokumentiert diese offene Abnahme daher, statt sie als Erfolg auszugeben.
